          ...
          <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
            ...
            <Link href="/signals" aria-label="View live FDI signals"
              style={{
                ...
                background:'rgba(116,187,101,0.1)',
                border:'1px solid rgba(116,187,101,0.3)',
                textDecoration:'none',flexShrink:0,
              }}>
              <span style={{
                display:'inline-block',width:'8px',height:'8px',
                borderRadius:'50%',background:'#74BB65',
                boxShadow:'0 0 6px rgba(116,187,101,0.6)',
            ...
            {/* Auth */}
            <Link href="/auth/login" style={{fontSize:'13px',fontWeight:'600',color:'#0A3D62',textDecoration:'none',padding:'6px 12px'}}>
              Sign In
            </Link>
            <Link href="/register" style={{fontSize:'13px',fontWeight:'600',color:'white',background:'#74BB65',borderRadius:'6px',padding:'8px 16px',textDecoration:'none'}}>
              Sign Up
            </Link>
            ...
            <button onClick={()=>setMobileOpen(m=>!m)}
              ...
              aria-label="Toggle menu" className="mobile-menu-btn">
              ☰
            </button>
          </div>
        </div>
            ...
            return (
              <Link key={item.href} href={item.href}
                style={{
                  ...
                  borderBottom: isActive ? '2px solid #74BB65' : '2px solid transparent',
