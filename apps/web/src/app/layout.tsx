...
export const metadata: Metadata = {
  ...
  description: "The world's most advanced FDI intelligence platform. GOSA-scored investment intelligence across 215+ economies.",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <style>{`html,body{background:#020c14}*{box-sizing:border-box}`}</style>
      </head>
